...
| — | ~~Five cards say "Available Colors"~~ | ✅ **CLOSED 19 Aug (`6ad07d9`).** SF90 → RED, 296 GTB → WHITE, 750S Spider → WHITE, 911 Carrera 4S → RED, Corvette Z06 → BLACK. Ali gave plain colours, not paint codes — that was his explicit call. The other 43 cards use specific paints (Bianco Icarus White, Chalk White…); harmonising is optional, not a defect. **Zero cards now say "Available Colors".** |
