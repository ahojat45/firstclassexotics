# First Class Exotics — handoff (26 Aug 2026)
...
**Last work commit `82bbe9b`**, pushed and deployed — Netlify `6a8e1dca…` ready/current, tree
clean, local == origin/main. A doc-only commit for this handoff sits on top of it.
**Site engineering is finished.** 22–24 Aug content (§12); 25 Aug reviews (§6); 26 Aug video (§13).
...
### 🔴 STILL BLOCKED ON ONE NUMBER — ASKED TWICE, NEVER ANSWERED
**The live Google review count has not been checked since 21 Aug, when it was 90.** Ali was
asked on 25 Aug (he replied "I'll check and tell you") and again on 26 Aug. He has not
supplied it. **26 drafts sit unsent in Gmail waiting on this number.**
...
1. 🔴 **GET THE GOOGLE REVIEW COUNT.** Asked 25 and 26 Aug, still unanswered. 90 on 21 Aug.
   **26 drafts sit unsent in Gmail waiting on it** (§6). An agent cannot read it — Chrome
   extension dead since 19 Aug, WebFetch unreliable. Ask him first thing, and read the answer
   against the table in §6. **This is the actual business needle.**
...
3. 💰 **Andreas Kunz — 11 rentals, silent 14 months** (§14). Nobody has asked why. Worth more
   than any name on the batch-2 list. First confirm whether he is the Alpha Solar partner.
4. **Ali never confirmed the 404 check** on `HANDOFF-2026-08-25.md`. Ask him to open
   `https://www.firstclassexotics.com/HANDOFF-2026-08-26.md` in Chrome — **bare URL, no query
   string** (§11 trap 1). Should return the branded 404. An agent cannot verify this.
5. **Video** (§13): the Huracán prompt is written and the references are de-badged, waiting on
   a run. The real constraint is source footage, not prompts — the twelve-shot field guide is
   at https://claude.ai/code/artifact/a3b97159-996e-445e-820e-317d514e735b
6. **#11 stock photos** — still needs Ali's decision. Do not start unilaterally.
...
## 14. 💰 ANDREAS KUNZ — 11 RENTALS, GONE QUIET. UNWORKED.
...
**One of the heaviest repeat customers in the book — and there has been nothing since
2 Jul 2025, roughly 14 months.** Correctly excluded from both review batches under the
repeat rule, but **nobody has looked at why he stopped.** He is worth more than any single
name on the batch-2 list.

⚠️ **Ask Ali whether this is his Alpha Solar partner.** He partners with an **Andy Koontz**;
this address is `andy.kunz.ventures@…` — similar name, different spelling, business-shaped
address. If it is the same person he is a partner who rents, not a customer, which changes
both the win-back and any review ask. Gmail cannot resolve this; only Ali can.
